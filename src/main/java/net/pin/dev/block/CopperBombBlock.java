...
public class CopperBombBlock extends Block {
    public CopperBombBlock(Settings settings) {
        super(settings);
    }
    ...
    private static void primeTnt(World world, BlockPos pos, @Nullable LivingEntity igniter) {
        if (!world.isClient) {
            CopperBombEntity tntEntity = new CopperBombEntity(world, (double)pos.getX() + 0.5, (double)pos.getY(), (double)pos.getZ() + 0.5, igniter);
