...
import net.pin.dev.entity.CopperBombEntity;
import net.pin.dev.entity.DiamondBombEntity;
import org.jetbrains.annotations.Nullable;

public class DiamondBombBlock extends Block {
    public DiamondBombBlock(Settings settings) {
        super(settings);
    }
    ...
    private static void primeTnt(World world, BlockPos pos, @Nullable LivingEntity igniter) {
        if (!world.isClient) {
            DiamondBombEntity tntEntity = new DiamondBombEntity(world, (double)pos.getX() + 0.5, (double)pos.getY(), (double)pos.getZ() + 0.5, igniter);
